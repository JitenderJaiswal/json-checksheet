                    ...
                    {moduleData.part_id === item._id ? (
                      <CustomIconButton
                        ...
                        onClick={() => {
                          ...
                          moduleData.partName2 = null;
                          moduleData.partNumber2 = null;
                      ...
                      <CustomIconButton
                        ...
                        onClick={() => {
                          moduleData.part_id = item?._id;
                          moduleData.partName2 = item?.part_name;
                          moduleData.partNumber2 = item?.part_number;
